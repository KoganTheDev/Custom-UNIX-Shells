/**
 * @file History.c
 * @brief Standalone executable backing the Math sub-shell's "History"
 * command: prints every command previously logged to Math_Commands.txt.
 */
...
/**
 * @brief Prints every command previously logged by MathShell, numbered.
